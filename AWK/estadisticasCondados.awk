...
FS = "\t"
	...
	menor_densidad = 1000000 nombre_menor_densidad= "a"
	mayor_porcentaje = 0
...
(NR > 1) 
{
	...
	{
		menor_porcentaje = porcentaje nombre_menor_porcentaje = $1
	}
	printf "%20s \t %f \t %f\n", $1, densidad, porcentaje 
}
END 
{
	printf "Mayor densidad de poblaci n: %s con %f hab/milla 2\n",
	nombre_mayor_densidad , mayor_densidad
	printf "Menor densidad de poblaci n: %s con %f hab/milla 2\n",
	nombre_menor_densidad , menor_densidad
	printf "Mayor porcentaje de agua: %s con %f \n", nombre_mayor_porcentaje,
	mayor_porcentaje
	printf "Menor porcentaje de agua: %s con %f \n", nombre_menor_porcentaje,
	menor_porcentaje 
}